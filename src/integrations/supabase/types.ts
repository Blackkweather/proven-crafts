...
// This file is generated by the Supabase CLI from your database schema.
// Re-generate it by running: npx supabase gen types typescript --local > src/integrations/supabase/types.ts
//
// It exports the `Database` type which describes every table, view, function,
// and enum in the Supabase project. The Supabase JS client is generic over this
// type (createClient<Database>(...)) so TypeScript knows the exact shape of
// every query result throughout the codebase.
//
// Also exports the `Json` type used for jsonb columns, and helper types like
// `Tables<"table_name">` and `Enums<"enum_name">` for convenience elsewhere.
//
// KEYWORDS: DATABASE
// =============================================================================
