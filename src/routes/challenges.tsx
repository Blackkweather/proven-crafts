...
import { challenges, getCompany } from "@/lib/mock-data";

export const Route = createFileRoute("/challenges")({
  head: () => ({
    meta: [
      { title: "Open challenges — Skill Network" },
      { name: "description", content: "Real, paid skill challenges from companies hiring on Skill Network. Submit work, not a cover letter." },
      { property: "og:title", content: "Open challenges — Skill Network" },
      { property: "og:description", content: "Submit work, not a cover letter. Real challenges from real teams." },
    ],
  }),
      ...
      <section className="container mx-auto px-6 pb-12 pt-20 lg:pt-28">
        <div className="grid gap-10 lg:grid-cols-12">
          <div className="lg:col-span-7">
            <div className="text-xs font-semibold uppercase tracking-[0.2em] text-muted-foreground">Open challenges</div>
            ...
            <p className="mt-5 max-w-xl text-lg text-muted-foreground">
              Companies post focused, scoped briefs — sometimes paid, sometimes a fast-track to hiring. You submit output, not a CV.
            </p>
          </div>
          <div className="lg:col-span-5">
            <div className="surface-paper rounded-2xl p-6">
              <div className="grid grid-cols-3 divide-x divide-border text-center">
                <Stat n={challenges.length.toString()} l="Live now" />
            ...
            >
              <div className="flex items-center justify-between">
                <span className="text-[10px] font-semibold uppercase tracking-[0.2em] text-background/60">
                  {company.name} · {c.deadlineDays} days left
                </span>
              ...
              <div className="mt-6 flex items-center justify-between border-t border-background/15 pt-4 text-xs">
                ...
                <span className="font-mono opacity-70 transition-opacity group-hover:opacity-100">View brief →</span>
              </div>
            </Link>
          );
        })}
