...
function Login() {
  ...
  async function submit(e: React.FormEvent) {
    ...
    // PostAuthRedirect in __root.tsx handles routing once roles are loaded.
  }
      ...
      {opts.map((o) => {
        ...
        return (
          ...
          >
            ...
            <div className={"mt-0.5 " + (active ? "text-background/70" : "text-muted-foreground")}>
              {o.d}
            </div>
          </button>
        );
...
function GoogleMark() {
  return (
    <svg width="16" height="16" viewBox="0 0 48 48" aria-hidden>
      ...
      <path
        fill="#4CAF50"
        d="M24 44c5.2 0 9.9-2 13.4-5.2l-6.2-5.2c-2 1.4-4.5 2.4-7.2 2.4-5.3 0-9.7-3.4-11.3-8l-6.5 5C9.4 39.6 16.1 44 24 44z"
      />
      <path
        fill="#1976D2"
      ...
      <div className="hidden flex-col justify-between bg-foreground p-12 text-background lg:flex">
        ...
        <div>
          ...
          <div className="mt-6 flex items-center gap-3">
            <div className="grid h-9 w-9 place-items-center rounded-full bg-background/10 font-display">
              JR
            </div>
